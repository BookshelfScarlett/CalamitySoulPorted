...
{
    public class PrismaticEnchant : GenericEnchant, ILocalizedModType
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual) => player.Soul().EnchPrismatic = true;
    }
}