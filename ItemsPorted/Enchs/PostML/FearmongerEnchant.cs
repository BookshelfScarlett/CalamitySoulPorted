...
{
    public class FearmongerEnchant : GenericEnchant, ILocalizedModType
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual) => player.Soul().EnchFearmonger = true;
    }
}