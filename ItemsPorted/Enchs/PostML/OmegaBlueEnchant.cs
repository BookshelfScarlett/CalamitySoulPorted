...
{
    public class OmegaBlueEnchant : GenericEnchant, ILocalizedModType
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual) => player.Soul().EnchOmegaBlue = true;
    }
}